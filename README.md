# EjercicioSencilloJavaMysQL_ver6

En esta versión -además de incorporarse las fucionalidades del anterior- se le incorpora un login y se juega con la desactivación y 
activación de componentes del interfaz gráfico según los  requerimientos del usuario.  
